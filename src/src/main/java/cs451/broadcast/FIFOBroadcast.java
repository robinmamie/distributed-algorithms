...
class FIFOBroadcast implements Broadcast {
    ...
    /**
     * Underlying uniform reliable broadcast.
     */
    private final URBroadcast urBroadcast;

    /**
     * Local message tallying: used to reorder messages that have been
     * URB-delivered.
     */
    ...
    /**
     * Listener from the upper instance called when a local message is effectively
     * FIFO-broadcast to everyone.
     */
    private final IntConsumer broadcastListener;

    /**
     * ID of the local instance, used to keep track of which local messages are
     * broadcast.
     */
     ...
     * @param myId              id of the local host, to keep track of which local
     *                          messages are broadcast.
     * @param deliver           listener used when a message is delivered.
     * @param broadcastListener listener used when a local message is broadcast.
     */
